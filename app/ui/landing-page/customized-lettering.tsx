    ...
    >
      ...
      >
        <p
          className="inline"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 1) ${getLineRevealProgress(0, 8) * 100}%, rgba(0, 0, 0, 0.2) 0%)`,
            backgroundClip: "text",
        ...
        <p
          className="inline"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 1) ${getLineRevealProgress(1, 8) * 100}%, rgba(0, 0, 0, 0.2) 0%)`,
            backgroundClip: "text",
            WebkitBackgroundClip: "text",
            color: "rgba(0, 0, 0, 0.2)",
            willChange: "background-position",
        ...
        <p
          className="inline"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 1) ${getLineRevealProgress(2, 8) * 100}%, rgba(0, 0, 0, 0.2) 0%)`,
            backgroundClip: "text",
            WebkitBackgroundClip: "text",
            color: "rgba(0, 0, 0, 0.2)",
            willChange: "background-position",
        ...
        <p
          className="inline"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 1) ${getLineRevealProgress(3, 8) * 100}%, rgba(0, 0, 0, 0.2) 0%)`,
            backgroundClip: "text",
            WebkitBackgroundClip: "text",
            color: "rgba(0, 0, 0, 0.2)",
            willChange: "background-position",
        ...
        <p
          className="inline"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 1) ${getLineRevealProgress(4, 8) * 100}%, rgba(0, 0, 0, 0.2) 0%)`,
            backgroundClip: "text",
            WebkitBackgroundClip: "text",
            color: "rgba(0, 0, 0, 0.2)",
            willChange: "background-position",
