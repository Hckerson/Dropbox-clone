...
export default function Security() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col items-center space-y-8 ">
      ...
      <div className="w-full text-center box-border flex space-x-3 justify-center items-center text-white">
        <Link
          href="#"
          className="py-3 px-5 inline-block rounded-xl ring-2 ring-white"
        >
          Get started free{" "}
          <svg
            viewBox="0 0 24 24"
