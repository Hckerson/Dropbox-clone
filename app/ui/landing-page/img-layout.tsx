...
export function ImgLayout() {
  return (
    <div
      style={{ aspectRatio: 1.6 , filter : 'drop-shadow(0 16px 32px rgba(0, 0, 0, .3))'}}
      className="w-auto h-full flex relative items-center max-h-full max-w-full box-border shadow-2xl"
    >
      <Image
...
export function MiniImg() {
  return (
    <div style={{aspectRatio : 0.46, maxHeight : '100%', maxWidth : '100%'}} className="w-auto px-10 sm:px-0  flex justify-center h-full relative box-border ">
      <Image
