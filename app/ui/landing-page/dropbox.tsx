...
export default function Dropbox() {
  ...
  return (
    <>
      <div
        className="flex w-full lg:px-0  xs:px-6 justify-center  flex-grow items-center bg-transparent -translate-y-[60px] box-border "
        id="big-box"
      >
        <div
          style={{
        ...
        >
          <div
            className="absolute bottom-0 top-0 left-0 h-full z-30 box-border hidden  md:block  md:w-11/12"
          >
            {" "}
            <ImgLayout />{" "}
          </div>
