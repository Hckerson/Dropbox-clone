              ...
              >
                ...
                <div className=" mb-8 box-border">
                  <Link href={link} className="group/svg">
                    <p className="inline underline underline-offset-2 decoration-1 hover:decoration-white transition-colors duration-200 decoration-stone-400 ">Read full story</p>
                    {" "}
                    <span className="">
                      <svg
                        viewBox="0 0 24 24"
