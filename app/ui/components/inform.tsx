...
export default function Information() {
  return (
    <div className="box-border w-full p-12 pb-16 grid">
      <div className="w-full box-border grid gap-y-5">
        ...
        <h1
          ...
          className={`font-normal box-border hyphens-manual text-3xl   md:text-4xl ${noto.className}`}
        >
          Do more than <br /> store with <br /> dropbox
        </h1>
      ...
      <div className="w-full box-border grid pt-6 gap-y-6">
        <div className="pr-6">
          <GetStarted />
        </div>
        <Link href="nav/login">
