...
export function SearchBar() {
  return (
    <div className="w-full flex rounded-[10px] space-x-1 border-opacity-25 border-2 hover:border-white hover:border-[1px] hover:border-opacity-65 border-stone-500">
